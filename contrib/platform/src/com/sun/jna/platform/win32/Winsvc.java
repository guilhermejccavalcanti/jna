...
public interface Winsvc {
    ...
    public static class SERVICE_STATUS extends Structure {
        ...
        public static final List<String> FIELDS = createFieldsOrder("dwServiceType", "dwCurrentState", "dwControlsAccepted", "dwWin32ExitCode", "dwServiceSpecificExitCode", "dwCheckPoint", "dwWaitHint");
    ...
    public class SERVICE_STATUS_PROCESS extends Structure {
        ...
        public static final List<String> FIELDS = createFieldsOrder("dwServiceType", "dwCurrentState", "dwControlsAccepted", "dwWin32ExitCode", "dwServiceSpecificExitCode", "dwCheckPoint", "dwWaitHint", "dwProcessId", "dwServiceFlags");
